...
- Nếu câu hỏi tham chiếu mơ hồ như:
  ...
  - "những gói đó"
  - "các khoản vay trên"
  => PHẢI phân tích lịch sử trò chuyện để xem khách hàng đang nhắc về các sản phẩm cụ thể nào và thay bằng tên sản phẩm được liệt kê cụ thể được nhắc đến gần nhất của bạn và người dùng
